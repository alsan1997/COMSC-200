...
BEGIN_MESSAGE_MAP(Ccomsc200Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &Ccomsc200Dlg::OnBnClickedButton1)
	ON_EN_CHANGE(IDC_EDIT1, &Ccomsc200Dlg::OnEnChangeEdit1)
	ON_EN_CHANGE(IDC_EDIT2, &Ccomsc200Dlg::OnEnChangeEdit2)
END_MESSAGE_MAP()
...
void Ccomsc200Dlg::OnBnClickedButton1()
{
	// TODO: Add your control notification handler code here
	CEdit* pEdit1 = (CEdit*)GetDlgItem(IDC_EDIT1);

	CEdit* result = (CEdit*)GetDlgItem(IDC_EDIT3);
	result->SetWindowText(CString(_T("browney")));

}

void Ccomsc200Dlg::OnEnChangeEdit1()
{
...
void Ccomsc200Dlg::OnEnChangeEdit2()
{
	// TODO:  If this is a RICHEDIT control, the control will not
	// send this notification unless you override the CDialogEx::OnInitDialog()
	// function and call CRichEditCtrl().SetEventMask()
