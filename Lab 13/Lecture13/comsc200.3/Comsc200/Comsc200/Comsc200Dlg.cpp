...
BEGIN_MESSAGE_MAP(CComsc200Dlg, CDialogEx)
  ...
  ON_BN_CLICKED(IDC_RADIO1, &CComsc200Dlg::OnBnClickedRadio1)
  ON_BN_CLICKED(IDC_RADIO2, &CComsc200Dlg::OnBnClickedRadio2)
...
void CComsc200Dlg::OnBnClickedRadio1()
{
  CEdit* pEdit2 = (CEdit*)GetDlgItem(IDC_EDIT2); 
  CEdit* pEdit3 = (CEdit*)GetDlgItem(IDC_EDIT3); 
  CStatic* pStatic2 = (CStatic*)GetDlgItem(IDC_STATIC2);
...
void CComsc200Dlg::OnBnClickedRadio2()
{
  CEdit* pEdit2 = (CEdit*)GetDlgItem(IDC_EDIT2); 
  CEdit* pEdit3 = (CEdit*)GetDlgItem(IDC_EDIT3); 
  CStatic* pStatic2 = (CStatic*)GetDlgItem(IDC_STATIC2);
